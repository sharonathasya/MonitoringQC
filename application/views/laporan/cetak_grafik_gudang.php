...
<head>
    <title>LAPORAN QUALITY CONTROL MASALAH GUDANG</title>
    <!-- jQuery -->
                ...
                success: function(data) {
                    ...
                    if (data['row'].length == 0) {
                        ...
                        var optionsp = {
                            ...
                            chart: {
                                title: 'Laporan Quality Control Masalah Gudang',
...
<body>
    <?php 
        //var_dump($post); die;
    ?>
    <h3>LAPORAN QUALITY CONTROL GRAFIK MASALAH GUDANG</h3>
    <hr>
    <p>GRAFIK <?php echo ($_POST['bulan'] != '' && $_POST['tahun'] != '') ? " BULAN " . $_POST['bulan'] . " " . $_POST['tahun'] : "SEMUA PERIODE"; ?></p>
    <div align="center">
        <div id="columnchart_gudang" style="width: 600px; height: 500px; margin: 20px;"></div>
    </div>
    <br>
    <p align="right">
        Dilaporkan oleh,
